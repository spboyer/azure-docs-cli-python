...
#### [Show](acr\webhook.pycliyml#show "az acr webhook show")
...
#### [Compute-Policy](dla\account\compute-policy.pycliyml "az dla account compute-policy")
...
#### [Ad-Admin](sql\server\ad-admin.pycliyml "az sql server ad-admin")
##### [Create](sql\server\ad-admin.pycliyml#create "az sql server ad-admin create")
##### [Delete](sql\server\ad-admin.pycliyml#delete "az sql server ad-admin delete")
##### [List](sql\server\ad-admin.pycliyml#list "az sql server ad-admin list")
##### [Update](sql\server\ad-admin.pycliyml#update "az sql server ad-admin update")
...
### [Assign-Identity](vm.pycliyml#assign-identity "az vm assign-identity")
...
### [Assign-Identity](vmss.pycliyml#assign-identity "az vmss assign-identity")
...
### [List-Instance-Public-Ips](vmss.pycliyml#list-instance-public-ips "az vmss list-instance-public-ips")
